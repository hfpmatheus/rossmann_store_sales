...
class Rossmann( object ):
    def __init__( self ):
        self.home_path = '/Users/mathe/Repos_ComunidadeDS/rossmann_store_sales/'
        self.competition_distance_scaler        = pickle.load( open( self.home_path + 'parameters/competition_distance_scaler', 'rb') )
        self.year_scaler                        = pickle.load( open( self.home_path + 'parameters/year_scaler', 'rb') )
        self.competition_duration_months_scaler = pickle.load( open( self.home_path + 'parameters/competition_duration_months_scaler', 'rb') )
        self.promo2_duration_weeks_scaler       = pickle.load( open( self.home_path + 'parameters/promo2_duration_weeks_scaler', 'rb') )
        self.store_type_encoding                = pickle.load( open( self.home_path + 'parameters/store_type_encoding', 'rb' ) )
    ...
    def data_transformation( self, df5 ):
        ...
        df5['competition_duration_months'] = self.competition_duration_months_scaler.transform( df5[['competition_duration_months']].values )

        # promo2 duration weeks
        df5['promo2_duration_weeks'] = self.promo2_duration_weeks_scaler.transform( df5[['promo2_duration_weeks']].values )
